...
<div>
    <div className='mt-64 text-center bg-[#f5fffc]'>
        ...
        <div className='xl:flex grid lg:grid-cols-2 w-auto justify-center relative  pt-20 md:pb-20 bg-[#f5fffc] p-20 md:p-10'>
                <h1 className='w-[80%] absolute hidden xl:inline bg-[#28af60] h-3 top-[45%]'> </h1>
        { save.map((asu, index) => (
                <div className='xl:flex grid w-auto lg:grid-cols-2 justify-center relative gap-10 pt-20 pb-20 p-10' key={index} >
              ...
              <div className='xl:flex grid lg:grid-cols-2 w-auto justify-center relative  md:pt-20 pb-20 bg-[#f5fffc] p-10'>
                <h1 className='w-[80%] absolute hidden xl:inline bg-[#28af60] h-3 top-[45%]'> </h1>
